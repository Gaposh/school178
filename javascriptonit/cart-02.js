...
window.addEventListener('click' , function(event){
    ...
    if(event.target.hasAttribute('data-cart')){
        ...
        const productInfo = {
            id: card.dataset.id  ,
            imgSrc : card.querySelector(".menu-item-image").getAttribute('src')  ,
            title : card.querySelector(".menu-item-name").innerText , 
        ...
        //Отображение статуса корзины (Пуста \ Полна )
        toggleCartStatus();

        //Пересчет общей стоимости элементов корзины
